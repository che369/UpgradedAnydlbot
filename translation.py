...
Expires on: {}"""
    ...
    AFTER_GET_DL_LINK = "<b>Direct Link generated</b> 👇\n \n{} \n \n<i>Generated link will expire in {} days.</i>.\n \nKindly use TDM Download manager for downloading on android mobile(Search in google play).Use IDM for pc.Because we are facing some issues while downloading on chrome & uc browser."
